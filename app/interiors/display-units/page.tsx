...
export const metadata: Metadata = {
  title: 'Display Units',
  description: 'Custom display units and showcases for homes and retail spaces, crafted with precision by TWC Fit-Outs.',
  alternates: { canonical: '/interiors/display-units' },
};
