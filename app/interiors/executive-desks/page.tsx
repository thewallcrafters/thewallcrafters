...
export const metadata: Metadata = {
  ...
  description: 'Premium executive desks and cabin furniture for modern offices, designed for productivity and style.',
  alternates: { canonical: '/interiors/executive-desks' },
};
