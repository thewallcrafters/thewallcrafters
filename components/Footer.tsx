...
const quickLinks = [
  ...
  { label: 'Wardrobes', href: '/interiors/storage' },
...
const socialLinks = [
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/thewallcrafters',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="md:col-span-3">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <a href="mailto:hello@thewallcrafters.com" className="text-twc-warm/70 text-sm font-light hover:text-twc-warm transition-colors">
                  hello@thewallcrafters.com
                </a>
              </div>
              <div>
